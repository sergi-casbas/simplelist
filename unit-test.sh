#!/bin/sh
clear
echo "Empty" | ./simplelist.py --sender=sergi.casbas@rstic.es --recipient=subscribe-milista@lists.rstic.es --local=subscribe-milista --domain=lists.rstic.es --mailbox=Inbox
...
echo "Empty" | ./simplelist.py --verbose=7 --sender=sergi@casbas.cat --recipient=subscribe-milista@lists.rstic.es --local=subscribe-milista --domain=lists.rstic.es --mailbox=Inbox
